        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="mb-4">
                <span className="text-sm sm:text-base font-sans font-bold tracking-wider text-neutral-600 uppercase bg-neutral-100/80 border border-neutral-200 px-4 py-1.5 rounded-md inline-block">
                  {categoryName}
                </span>
              ...
              {/* Specification Table (Styled with clean transparent background, expanded description width and matching font size) */}
              <div className="border border-neutral-200/80 rounded-xl overflow-hidden bg-transparent shadow-xs mt-6 w-full">
